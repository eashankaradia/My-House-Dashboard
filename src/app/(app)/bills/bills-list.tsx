            ...
            <div key={bill.id} className="flex items-center gap-3 py-2 text-sm first:pt-0 last:pb-0">
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                ...
                <BillForm
                  ...
                  accounts={accounts}
                  trigger={
                    <button aria-label="Edit bill" className="inline-flex items-center justify-center rounded-md p-1.5 text-muted-foreground hover:bg-accent hover:text-foreground">
