      ...
      <CardContent className="space-y-4 p-5">
        ...
        <div className="absolute right-3 top-3 flex items-center">
          <PotForm
            pot={pot}
            trigger={
              <button aria-label="Edit pot" className="inline-flex items-center justify-center rounded-md p-1.5 text-muted-foreground hover:bg-accent hover:text-foreground">
