      ...
      actions={
        <>
          ...
          <MaintenanceForm
            task={task}
            trigger={
              <button aria-label="Edit task" className="inline-flex items-center justify-center rounded-md p-1.5 text-muted-foreground hover:bg-accent hover:text-foreground">
